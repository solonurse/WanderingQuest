      ...
      <div className="flex flex-col mx-auto gap-8 text-center my-5 w-3/4">
        ...
        <FormProvider {...methods}>
          <form className="w-full" onSubmit={methods.handleSubmit(onSubmit)}>
            ...
            <ActionMission />
            <TimeLimit />
            <button type="submit" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 border border-red-600 rounded shadow-md active:shadow-sm">ミッション開始</button>
          </form>
        </FormProvider>
      </div>
    </div>
