const Term = () => {
  return (
    <div className="mx-auto my-5 w-9/12">
      <h1 className="text-4xl mb-3 text-center">利用規約</h1>
      <p>
        この利用規約（以下，「本規約」といいます。）は，WanderingQuest（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>
      ...
      <h2 className="text-2xl">第3条（ユーザーIDおよびパスワードの管理）</h2>
      <p>
